...
let tamanhos = 'Pequeno'
let tamanhosLower = tamanhos.toLowerCase();

if (tamanhosLower == 'pequeno') {
    console.log(`Você escolheu o tamanho ${tamanhosLower}, leva 5 minutinhos para ficar pronto. Super rápido né ✨?.`);
} 

else if (tamanhosLower == 'medio') {
    console.log(`Você escolheu o tamanho ${tamanhosLower}, leva 10 minutos para ficar pronto. Você nem vai sentir 🌈.`);
}

else if (tamanhosLower == 'grande') {
    console.log(`Você escolheu o tamanho ${tamanhosLower}, leva 15 minutos para ficar pronto. Passa rapidinho, tá 🤗?`);
}
